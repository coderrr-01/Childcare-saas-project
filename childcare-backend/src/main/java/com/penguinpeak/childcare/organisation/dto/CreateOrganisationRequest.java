...
public record CreateOrganisationRequest(
        ...
        @Size(max = 20) String abn, @Email @Size(max = 255) String email, @Size(max = 30) String phone,
        @Size(max = 500) String website, String logoUrl, @Size(max = 200) String addressStreet,
